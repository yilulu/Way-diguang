...
namespace DTcms.Model
{
    ...
    public class siteconfig
    {
        ...
        private int _kindmaxheight = 0;
        private int _kindmaxwidth = 0;
        ...
        /// 編輯器图片最大高度(像素)
        /// </summary>
        public int kindmaxheight
        {
            get { return _kindmaxheight; }
            set { _kindmaxheight = value; }
        }
        /// <summary>
        /// 編輯器图片最大宽度(像素)
        /// </summary>
        public int kindgmaxwidth
        {
            get { return _kindmaxwidth; }
            set { _kindmaxwidth = value; }
        }
        /// <summary>
        /// 生成缩略图高度(像素)
        /// </summary>
