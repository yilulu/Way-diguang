<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoteBook.aspx.cs" Inherits="DTcms.Web.plugins.feedback.admin.NoteBook" %>
...
<body class="mainbody">
    ...
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <asp:LinkButton ID="lbtnUnLock" runat="server" CssClass="tools_btn" OnClientClick="return ExePostBack('lbtnUnLock','审核后前台将显示该信息，确定继续吗？');"
                OnClick="lbtnUnLock_Click"><span><b class="stop">批量审核</b></span></asp:LinkButton>
    ...
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center">
                    <a href="../feedback.aspx?id=<%#Eval("id")%>">回复</a>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
