...
<form id="form1" runat="server">
    <div class="navigation">首頁 &gt; 控制桌面 &gt; 管理員管理</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="manager_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加管理員</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th width="12%" align="left">聯繫電話</th>
        <th width="15%" align="left">郵箱</th>
        <th width="16%" align="left">添加時間</th>
        <th width="6%">狀態</th>
        <th width="6%">操作</th>
      </tr>
    </HeaderTemplate>
