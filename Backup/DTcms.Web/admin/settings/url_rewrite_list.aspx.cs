...
namespace DTcms.Web.admin.settings
{
    public partial class url_rewrite_list : DTcms.Web.UI.ManagePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("sys_config", DTEnums.ActionEnum.View.ToString()); //檢查權限
                RptBind();
            }
        }
        ...
        {
            ChkAdminLevel("sys_config", DTEnums.ActionEnum.Edit.ToString()); //檢查權限
            ...
            JscriptMsg("URL規則刪除成功！", "url_rewrite_list.aspx", "Success");
        }
