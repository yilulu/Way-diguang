...
{
    public partial class helper : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("helper.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("helper.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void ibtnViewTxt_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("helper.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("儲存排序成功！", Utils.CombUrlTxt("helper.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
