<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_dg.aspx.cs" Inherits="DTcms.Web.admin.goods.edit_dg"
...
<body class="mainbody">
    ...
    <div class="navigation">
        <a href="javascript:history.go(-1);" class="back">後退</a>首頁 &gt; 帝光精品管理 &gt; 編輯資料</div>
    <div id="contentTab">
        <ul class="tab_nav">
            ...
            <table class="form_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtIntroduce" TextMode="MultiLine" runat="server" CssClass="txtInput small required"
