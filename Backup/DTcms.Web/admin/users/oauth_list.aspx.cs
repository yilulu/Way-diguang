...
namespace DTcms.Web.admin.users
{
    public partial class oauth_list : Web.UI.ManagePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("儲存排序成功！", Utils.CombUrlTxt("oauth_list.aspx", "keywords={0}", this.keywords), "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批次刪除成功！", Utils.CombUrlTxt("oauth_list.aspx", "keywords={0}", this.keywords), "Success");
        }
