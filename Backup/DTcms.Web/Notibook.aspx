    ...
    <script type="text/javascript">
      ...
      function () {
        ...
        function valdata() {
            ...
            var Phone = $("#ctl00_ContentPlaceHolder1_txtPhone").val();
            var Tel = $("#ctl00_ContentPlaceHolder1_txtTel").val();
            var Content = $("#ctl00_ContentPlaceHolder1_txtContent").val();
            var zhuzhi = $('input[name="chkZhuZhi"]:checked').val();
          var Ower = $("#ctl00_ContentPlaceHolder1_txtOwer").val();
           var OwerTel = $("#ctl00_ContentPlaceHolder1_txtOwerTel").val();3
            ...
            if (Tel == "") {
                alert("請輸入家庭電話");
                $("#ctl00_ContentPlaceHolder1_txtTel").focus();
                return false;
            }
            ...
            <div id="main1">
                <table border="0" class="liuyanb" cellspacing="0" cellpadding="0" align="left" width="800">
                    <tr>
                        ...
                        <td width="283">
                            <input type="radio" name="radio" id="radio" value="男" runat="server" />
                            男
                            <input type="radio" name="radio" id="radio2" value="女" runat="server" />
                            女 (勾選)
                        </td>
                    </tr>
                    <tr>
