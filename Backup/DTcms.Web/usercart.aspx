    ...
    <div id="vip_3">
        ...
        <div id="vip_3_2">
            <span class="vip_3_2_1">我的購物車</span> <span class="vip_3_2_2">
                <input type="button" onclick="window.location.href='producJP.aspx?mid=5'" style="background-image: url('images/jxgw.png');
                    width: 100px; height: 30px;" />
                <%if (ISb)
                  { %><%--<a href="orderadd.aspx" target="_blank">--%>
                <input type="button" onclick="window.location.href='orderadd.aspx'" style="background-image: url('images/addorder.jpg');
        ...
        <div id="vip_3_3">
            <asp:Repeater ID="repddata" runat="server" OnItemCommand="repddata_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        <td width="150">
                            <a href="<%#Eval("GoodsImage")%>" target="_blank">
                                <img src="<%#Eval("GoodsImage")%>" name="vip_ico3_3" width="127" height="96" /></a>
                        </td>
                        <td width="300">
                            <span class="xgj_ms"><a href="#">
                                <%#Eval("GoodsName")%></a></span>
                        </td>
                        ...
                        <td width="100" align="center">
                            <p>
                                <asp:LinkButton ID="lbtndelete" runat="server" Text="删除" CommandName="del" CommandArgument='<%#Eval("GoodsId")%>' /></p>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    <tr>
                        <td colspan="6" style="text-align: right; margin-right: 30px;">
                            金額小計： $<%=SinglePrice%>
                        </td>
                    </tr>
                    <tr>
