...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ziye_ymx">
        當前位置：帝光地產聯盟>>送出訂單</div>
    <div id="login_1">
        <span class="login_1_1">訂單資料</span></div>
                            ...
                            <tr>
                                <td align="center" bgcolor="#FFFFFF">
                                    <div style="width: 99%; height: 20px; line-height: 20px; overflow: hidden;">
                                        <a title="<%# Eval("GoodsName") %>">
                                            <%# Eval("GoodsName")%></a></div>
                                </td>
                                <td align="center" bgcolor="#FFFFFF">
                                    <div style="padding-top: 5px; padding-bottom: 5px;">
                                        <img src="<%# Eval("GoodsImage")%>" /></div>
                                </td>
                                <td align="center" bgcolor="#FFFFFF">
                                    $<%# Eval("GoodsPrice", "{0:0.00}")%>
                                </td>
                                <td align="center" bgcolor="#FFFFFF">
                                    <%# Eval("GoodsCount")%>
                                </td>
                                <td align="center" bgcolor="#FFFFFF">
                                    $<%# Eval("GoodsTotal", "{0:0.00}")%>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                            ...
                            <div style="padding: 10px;">
                                <table width="0" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            商品總金額：<span id="TotalPrice">$<%=PousePrice%></span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
