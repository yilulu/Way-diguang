<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upFile.aspx.cs" Inherits="DTcms.Web.upFile1" %>
        ...
        $(function () {
            $("#form1").validate({
                invalidHandler: function (e, validator) {
                    jsprint("有 " + validator.numberOfInvalids() + " 項填寫有誤，請檢查！", "", "Warning");
                },
                errorPlacement: function (lable, element) {
                    //可見元素顯示錯誤提示
                    if ($(".tab_con").css('display') != 'none') {
...
<body class="mainbody">
    ...
    <div class="navigation">
        <a href="javascript:history.go(-1);" class="back">後退</a>首頁 &gt; 下載管理 &gt; 編輯資料</div>
    <div id="contentTab">
        <ul class="tab_nav">
                                    ...
                                    <asp:Repeater ID="rptAttach" runat="server">
                                        <ItemTemplate>
                                            <li>
                                                ...
                                                <span class="title">附件：<%#Eval("title")%></span> <span>
                                                    <%#Convert.ToInt32(Eval("file_size")) < 1024 ? Eval("file_size").ToString() + "KB" : Convert.ToInt32(Eval("file_size"))/1024 + "MB"%></span>
                                                <span>人氣：<%#Eval("down_num")%></span> <a href="javascript:;" class="upfile">
                                                    <input type="file" name="FileUpdate" onchange="AttachUpdate('hidFileName',this);" /></a>
                                                <span class="uploading">正在更新...</span> </li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
                            </div>
