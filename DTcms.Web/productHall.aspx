<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="productHall.aspx.cs" Inherits="DTcms.Web.productHall" %>
                                    ...
                                    <ul class="cs_tu2">
                                        <span class="cs_tu2_1">區域;
                                            <%#GetA(Eval("Areaid").ToString())%></span> <span class="cs_tu2_2" style="width: 300px;">
                                                地址:<%#Eval("dizhi")%>&nbsp; </span><span class="cs_tu2_3">桌數:
                                                    <%#Eval("link_url")%>桌 </span><span class="cs_tu2_4">樓層:
                                                        <%#Eval("louceng")%>樓</span> <span class="cs_tu2_5">車位:
                                                            <%#Eval("chewei")%></span> <span class="cs_tu2_6">廚房:<%#Eval("stock_quantity").ToString()=="1"?"有":"無"%></span>
                                        <span class="cs_tu2_7">舞台:
                                            <%#Eval("fangshi").ToString() == "1" ? "有" : "無"%></span>
                                        <%--<span class="cs_tu2_8">
