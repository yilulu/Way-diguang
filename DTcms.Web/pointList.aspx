<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="pointList.aspx.cs" Inherits="DTcms.Web.pointList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ziye_ymx">
        當前位置：帝光地產聯盟>>積點記錄</div>
    <div id="vip_3">
        <!--會員左邊菜單-->
        <uc1:usermenu ID="usermenu1" runat="server" />
        <div id="vip_3_2">
            <span class="vip_3_2_1">積點記錄</span><%--<span class="vip_3_2_2"><img src="../images/vip_ico1.jpg"
