<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="zhsj.aspx.cs" Inherits="DTcms.Web.front.zhsj" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            //初始化上傳控制項
            $(function () {
                InitSWFUpload("../../tools/upload_ajax.ashx", "Filedata", "1000 KB", "../../scripts/swfupload/swfupload.swf", 1, 1);
            });
            //計算用戶組價格
            $(function () {
    	...
    	#contentTab select{ border:1px solid #ccc !important; }
    </style>
    <body class="mainbody">
