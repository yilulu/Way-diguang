...
<body class="mainbody">
    ...
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <a href="group_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span>
                <b class="add">添加組別</b></span></a> <a href="javascript:void(0);" onclick="checkAll(this);"
            ...
            <asp:LinkButton ID="btnDelete" runat="server" CssClass="tools_btn" OnClick="btnDelete_Click"
                OnClientClick="return ExePostBack('btnDelete');"><span><b class="delete">批次刪除</b></span></asp:LinkButton>
        </div>
    </div>
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center">
                    <%#Convert.ToInt32(Eval("is_lock")) == 1 ? "禁用" : "啟用"%>
                </td>
                <td align="center">
