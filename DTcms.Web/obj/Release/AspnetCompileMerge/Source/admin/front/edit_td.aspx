<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="edit_td.aspx.cs"
    Inherits="DTcms.Web.admin.front.edit_td" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">
            <a href="javascript:history.go(-1);" class="back">後退</a>首頁 &gt; 商品管理 &gt; 編輯資料
        </div>
        <div id="contentTab">
            <ul class="tab_nav">
                ...
                <table class="form_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlArea" CssClass="select2" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNo" runat="server" CssClass="txtInput normal required" Width="350"
                                    MaxLength="100" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtChiFen" runat="server" CssClass="txtInput normal required" Width="350"
                                    MaxLength="100" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtUserTo" runat="server" CssClass="txtInput normal required" Width="350"
                                    MaxLength="100" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDImu" runat="server" CssClass="txtInput normal" Width="350" MaxLength="100" />
                            </td>
                        </tr>
                        <tr>
                            <th>容積率：
                            ...
                            <td>
                                <asp:TextBox ID="txtRongyiLv" runat="server" CssClass="txtInput normal" Width="350"
                                    MaxLength="100" />%
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtJianBiLv" runat="server" CssClass="txtInput normal" Width="350"
                                    MaxLength="100" />%
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNowPrice" runat="server" CssClass="txtInput normal required"
                                    Width="350" MaxLength="100" />元/㎡
                            </td>
                        </tr>
                        <tr>
                            <th>地上物：
                            ...
                            <td>有
                            <asp:CheckBox ID="chkDiShangWu" runat="server" />
                            </td>
                        </tr>
                        <%-- <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRoadsWidth" runat="server" CssClass="txtInput normal" Width="350"
                                    MaxLength="100"></asp:TextBox>米
                            </td>
                        </tr>
                        <%--<tr>
                        <th>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlForm" CssClass="select2" runat="server">
                                <asp:ListItem Value="0">請選擇</asp:ListItem>
                                <asp:ListItem Value="1">帆布</asp:ListItem>
                                <asp:ListItem Value="2">LED燈</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTime" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                    runat="server" CssClass="txtInput normal required " MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <th>是否首頁顯示：
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMarketPrice" runat="server" CssClass="txtInput small required number"
                                    MaxLength="10">0</asp:TextBox>萬<span id="TiShi" runat="server"></span>
                                <label>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSinglePrice" runat="server" CssClass="txtInput small required number"
                                    MaxLength="10">0</asp:TextBox><span id="Span2" runat="server"></span>
                                <label>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPrice" runat="server" CssClass="txtInput small required number"
                                    MaxLength="10">0</asp:TextBox>元/月<span id="Span1" runat="server"></span>
                                <label>
                                </label>
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMianJi" runat="server" class="txtInput normal left" Text="0"></asp:TextBox>(坪)
                            </td>
                        </tr>
                        <tr>
                            <th>捷運沿線：
        ...
        <script type="text/javascript">
            ...
            function getLat() {
                var add = document.getElementById("txtdizhi");
                xmlhttp.open("GET", "../../tools/getLat.ashx?add=" + escape(add.value) + "&math=" + myMath, true);
            ...
            function doadd() {
                if (xmlhttp.readyState == 4) {
                    if (xmlhttp.status == 200) {
                        ...
                        var nl = document.getElementById("txtY");
                        nl.value = result;
                    }
                }
            }
