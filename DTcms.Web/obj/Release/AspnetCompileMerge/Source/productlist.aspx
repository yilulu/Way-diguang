<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="productlist.aspx.cs" Inherits="DTcms.Web.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ziye_ymx">
        當前位置：<a href="index.aspx">帝光地產聯盟</a>>><%=GetTitle() %>
    </div>
    <div id="ziye_middle">
            ...
            <div id="main">
                <div id="menubox">
                    ...
                    <ul>
                        ...
                        <li id="zzjs2"><a href="productTdList.aspx?mid=<%=channel_id %>">土地</a></li>
                    </ul>
                </div>
                <div id="conten">
                                ...
                                <ul class="cs_tu">
                                    ...
                                    <ul class="cs_tu2">
                                        <span class="cs_tu2_1">區域;
                                            <%#GetA(Eval("Areaid").ToString())%></span> <span class="cs_tu2_2" style="width: 300px;">地址:<%#Eval("dizhi")%>&nbsp; </span><span class="cs_tu2_3">戶型:
                                    ...
                                    <ul class="cs_tu3">
                                        ...
                                        <li class="cs_tu3_1">每坪單價:  <%#Eval("yongtu")%><%=sellOrHire %></li>
                                        <li class="cs_tu3_1"><a href="productview.aspx?id=<%#Eval("id")%>&mid=<%#Eval("channel_id") %>">查看詳情>></a></li>
                                    </ul>
                                </ul>
                            </ItemTemplate>
                        </asp:Repeater>
