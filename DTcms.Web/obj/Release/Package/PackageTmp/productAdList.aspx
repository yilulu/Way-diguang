<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="productAdList.aspx.cs" Inherits="DTcms.Web.productAdList" %>
                                    ...
                                    <ul class="cs_tu2">
                                        <span class="cs_tu2_1">區域;
                                            <%#GetA(Eval("Areaid").ToString())%></span> <span class="cs_tu2_2" style="width: 300px;">
                                                地址:<%#Eval("dizhi")%>&nbsp; </span><span class="cs_tu2_3">形式:
                                                    <%#Eval("shangpinType")%> </span><span class="cs_tu2_4">樓層:
                                                        <%#Eval("louceng")%>樓</span> <span class="cs_tu2_2">尺寸:
                                                            <%#Eval("fuwuxiangju")%></span> 
                                    </ul>
                                    <ul class="cs_tu3">
