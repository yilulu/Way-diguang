<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="DTcms.Web.plugins.feedback.admin.feedback" %>
            ...
            <table class="form_table">
                ...
                <asp:Panel ID="p1" runat="server">
                    <tr>
                        ...
                        <td><input type="hidden" id="chkPointValue"  runat="server" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtReContent" runat="server" CssClass="txtInput normal required"
