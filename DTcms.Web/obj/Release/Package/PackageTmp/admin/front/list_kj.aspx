<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list_kj.aspx.cs" Inherits="DTcms.Web.admin.front.list_kj" %>
...
<body class="mainbody">
    ...
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <a href="edit_kj.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
    ...
    <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="edit_kj.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%></a>
                </td>
                <td>
        ...
        <ItemTemplate>
            <li>
                <div class="box">
                    ...
                    <dl>
                        <dt><a href="edit_kj.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("title")%></a></dt>
                        <dd>
