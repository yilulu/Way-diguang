...
<form id="form1" runat="server">
    <div class="navigation">首頁 &gt; 郵件範本管理 &gt; 內容列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="mail_template_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加範本</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">選擇</th>
        <th width="12%" align="left">調用別名</th>
        <th width="15%" align="left">標題</th>
        <th align="left">郵件標題</th>
        <th width="12%">系統默認</th>
        <th width="8%">操作</th>
      </tr>
    </HeaderTemplate>
