    ...
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
                class="tools_btn"><span><b class="add">添加文章</b></span></a>
        ...
        <div class="select_box">
            ...
            <asp:ImageButton ID="ibtnViewImg" runat="server" ImageUrl="../images/ico-show-img.png"
                ToolTip="圖片列表視圖" OnClick="ibtnViewImg_Click" />
        </div>
    </div>
    <!--列表展示.開始-->
        ...
        <ItemTemplate>
            <li>
                <div class="box">
                    ...
                    <dl>
                        <dt><a href="edit.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("title")%></a></dt>
                        <dd>
                            作者：<%#Eval("author")%>&nbsp; 來源：<%#Eval("from")%>&nbsp; 人氣：<%#Eval("click")%></dd>
                        <dd>
                            發佈時間：<%#string.Format("{0:g}",Eval("add_time"))%></dd>
                        <dd class="btns">
                            <span class="right">
                                <%--<asp:ImageButton ID="ibtnMsg" CommandName="ibtnMsg" runat="server" ImageUrl='<%# Eval("is_msg")==null?"../images/ico-0.png" : Convert.ToInt32(Eval("is_msg")) == 1 ? "../images/ico-0.png" : "../images/ico-0_.png"%>' ToolTip='<%# Eval("is_msg")==null?"":Convert.ToInt32(Eval("is_msg")) == 1 ? "取消評論" : "設置評論"%>' />
                <asp:ImageButton ID="ibtnTop" CommandName="ibtnTop" runat="server" ImageUrl='<%# Eval("is_top")==null?"../images/ico-1.png" :Convert.ToInt32(Eval("is_top")) == 1 ? "../images/ico-1.png" : "../images/ico-1_.png"%>' ToolTip='<%# Eval("is_top")==null?"":Convert.ToInt32(Eval("is_top")) == 1 ? "取消置頂" : "設置置頂"%>' />
                <asp:ImageButton ID="ibtnRed" CommandName="ibtnRed" runat="server" ImageUrl='<%# Eval("is_red")==null?"../images/ico-2.png" :Convert.ToInt32(Eval("is_red")) == 1 ? "../images/ico-2.png" : "../images/ico-2_.png"%>' ToolTip='<%# Eval("is_red")==null?"":Convert.ToInt32(Eval("is_red")) == 1 ? "取消推薦" : "設置推薦"%>' />
                <asp:ImageButton ID="ibtnHot" CommandName="ibtnHot" runat="server" ImageUrl='<%# Eval("is_hot")==null?"../images/ico-3.png" :Convert.ToInt32(Eval("is_hot")) == 1 ? "../images/ico-3.png" : "../images/ico-3_.png"%>' ToolTip='<%# Eval("is_hot")==null?"":Convert.ToInt32(Eval("is_hot")) == 1 ? "取消熱門" : "設置熱門"%>' />
                <asp:ImageButton ID="ibtnSlide" CommandName="ibtnSlide" runat="server" ImageUrl='<%# Eval("is_slide")==null?"../images/ico-4.png" :Convert.ToInt32(Eval("is_slide")) == 1 ? "../Images/ico-4.png" : "../Images/ico-4_.png"%>' ToolTip='<%# Eval("is_slide")==null?"":Convert.ToInt32(Eval("is_slide")) == 1 ? "取消幻燈片" : "設置幻燈片"%>' />--%>
                                <a href="edit.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
