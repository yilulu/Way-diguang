<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list_dg.aspx.cs" Inherits="DTcms.Web.admin.goods.list_dg" %>
...
<body class="mainbody">
    ...
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <a href="edit_dg.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
                class="tools_btn"><span><b class="add">添加帝光精品</b></span></a>
    ...
    <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="edit_dg.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%></a>
                </td>
                <td>
        ...
        <ItemTemplate>
            <li>
                <div class="box">
                    ...
                    <dl>
                        <dt><a href="edit_dg.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("title")%></a></dt>
                        <dd>
