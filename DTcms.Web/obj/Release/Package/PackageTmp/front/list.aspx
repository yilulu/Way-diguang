<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.front.list" %>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="<%#(chkUrlByChannel_id(Eval("channel_id").ToString())) %>.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("title")%></a>
                    </td>
                    <td>
                    ...
                    <td align="center">
                        <a href="<%#(chkUrlByChannel_id(Eval("channel_id").ToString())) %>.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
            ...
            <ItemTemplate>
                <li>
                    <div class="box">
                        ...
                        <dl>
                            <dt><a href="<%#(chkUrlByChannel_id(Eval("channel_id").ToString())) %>.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                                <%#Eval("title")%></a></dt>
                ...
                <a href="sell.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><img src="../images/ico-6.png" style="vertical-align:middle;" title="修改" /></a>
              </span>--%>
