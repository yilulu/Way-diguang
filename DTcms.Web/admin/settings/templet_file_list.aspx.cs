...
namespace DTcms.Web.admin.settings
{
    ...
    {
        protected string skinName; //範本目錄
        ...
        {
            ChkAdminLevel("sys_templet", DTEnums.ActionEnum.Delete.ToString()); //檢查許可權
            ...
            JscriptMsg("檔案刪除成功！", Utils.CombUrlTxt("templet_file_list.aspx", "skin={0}", this.skinName), "Success");
        }
    }
}
