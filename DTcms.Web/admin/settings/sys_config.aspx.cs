...
namespace DTcms.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("sys_config", DTEnums.ActionEnum.View.ToString()); //檢查許可權
                ShowInfo();
            }
        }
        ...
        private void ShowInfo()
        {
            ...
            {
                weburl.Attributes["value"] = defaultpassword;
            }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //判斷密碼是否更改
                if (weburl.Text.Trim() != defaultpassword)
                {
                ...
                model.kindmaxheight = int.Parse(Kindmaxheight.Text.Trim());
                model.kindgmaxwidth = int.Parse(Kindmaxwidth.Text.Trim());
                ...
                JscriptMsg("修改系統資料成功！", "sys_config.aspx", "Success");
            }
            catch
            {
                JscriptMsg("檔案寫入失敗，請檢查是否有權限！", "", "Error");
            }
        }
    }
}
