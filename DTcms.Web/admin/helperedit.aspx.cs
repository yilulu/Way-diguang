...
{
    public partial class helperedit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改商品成功！", "helper.aspx?channel_id=" + this.channel_id, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加商品成功！", "helper.aspx?channel_id=" + this.channel_id, "Success");
            }
        }
    }
}
