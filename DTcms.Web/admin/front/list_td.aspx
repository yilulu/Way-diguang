<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list_td.aspx.cs" Inherits="DTcms.Web.admin.front.list_td" %>
...
<body class="mainbody">
    ...
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <a href="edit_td.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
    ...
    <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="edit_td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%></a>
                </td>
                <td>
                    <%#Eval("shequ")%>
        ...
        <ItemTemplate>
            <li>
                <div class="box">
                    ...
                    <dl>
                        <dt><a href="edit_td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("title")%></a></dt>
                        <dd>
                ...
                <asp:ImageButton ID="ibtnHot" CommandName="ibtnHot" runat="server" ImageUrl='<%# Convert.ToInt32(Eval("is_hot")) == 1 ? "../images/ico-3.png" : "../images/ico-3_.png"%>' ToolTip='<%# Convert.ToInt32(Eval("is_hot")) == 1 ? "取消熱門" : "設置熱門"%>' />
                <asp:ImageButton ID="ibtnSlide" CommandName="ibtnSlide" runat="server" ImageUrl='<%# Convert.ToInt32(Eval("is_slide")) == 1 ? "../Images/ico-4.png" : "../Images/ico-4_.png"%>' ToolTip='<%# Convert.ToInt32(Eval("is_slide")) == 1 ? "取消幻燈片" : "設置幻燈片"%>' />
                <a href="edit_td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.edit_td %>&id=<%#Eval("id")%>"><img src="../images/ico-6.png" style="vertical-align:middle;" title="修改" /></a>
              </span>--%>
