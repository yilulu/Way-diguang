...
{
    public partial class list_td : Web.UI.ManagePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("儲存排序成功！", Utils.CombUrlTxt("list_td.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批次刪除成功！", Utils.CombUrlTxt("list_td.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
