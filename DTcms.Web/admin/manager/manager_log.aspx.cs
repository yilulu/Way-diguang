...
namespace DTcms.Web.admin.manager
{
    public partial class manager_log : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("sys_log", DTEnums.ActionEnum.View.ToString()); //檢查許可權
        ...
        {
            ChkAdminLevel("sys_log", DTEnums.ActionEnum.Delete.ToString()); //檢查許可權
            BLL.manager_log bll = new BLL.manager_log();
            ...
            JscriptMsg("批次刪除成功！", Utils.CombUrlTxt("manager_log.aspx", "keywords={0}", this.keywords), "Success");
        }
