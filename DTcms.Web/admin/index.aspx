    ...
    <form id="form1" runat="server">
        ...
        <div id="global_layout" class="layout" style="width: 100%">
            ...
            <div position="left" title="管理菜單" id="global_left_nav">
                ...
                <div title="前臺數據收集" iconcss="menu-icon-model" class="l-scroll">
                    <ul class="nlist">
                        <li><a href="javascript:f_addTab('front/list','出售','front/list.aspx?channel_id=2')">出售</a></li>
                        <li><a href="javascript:f_addTab('front/list1','出租','front/list.aspx?channel_id=3')">出租</a></li>
                        <li><a href="javascript:f_addTab('front/list_kj','裝潢','front/list_kj.aspx?channel_id=4')">裝潢</a></li>
                        <li><a href="javascript:f_addTab('front/list_td','土地','front/list_td.aspx?channel_id=10')">土地</a></li>
                    </ul>
                </div>
                ...
                <div title="會員管理" iconcss="menu-icon-member">
                  ...
                  { %>
                        ...
                        { %>
                        <li><a href="javascript:f_addTab('mail_template','郵件範本管理','users/mail_template_list.aspx')">郵件範本管理</a></li>
                        <%}
                   ...
                   { %>
                        <li><a class="l-link" href="javascript:f_addTab('user_config','會員參數配置','users/user_config.aspx')">會員參數配置</a></li>
                        <%} %>
                    </ul>
                </div>
                <div title="銷售管理" iconcss="menu-icon-order">
                    <ul class="nlist">
                        ...
                        <%}
                          if (IsAdminLevel("user_config", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a href="javascript:f_addTab('order_payment','付款方式設置','orders/payment_list.aspx')">付款方式設置</a></li>
                        <%}%>
                    </ul>
                </div>
                <%} %>
                ...
                <div title="控制桌面" iconcss="menu-icon-setting">
                    <ul class="nlist">
                        <%if (IsAdminLevel("sys_config", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('sys_config','系統參數設置','settings/sys_config.aspx')">系統參數設置</a></li>
                        <%} if (IsAdminLevel("sys_model", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('sys_model','房屋類型設置','settings/sys_model_list.aspx')">房屋類型設置</a></li>
                        <%} if (IsAdminLevel("sys_channel", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('sys_channel','系統頻道設置','settings/sys_channel_list.aspx')">系統頻道設置</a></li>
                        <%} if (IsAdminLevel("sys_plugin", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('plugin_list','系統插件管理','settings/plugin_list.aspx')">系統插件管理</a></li>
                        <%}
                          if (IsAdminLevel("sys_log", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('manager_log','系統日誌管理','manager/manager_log.aspx')">系統日誌管理</a></li>
                        <%} %>
                        <li><a class="l-link" href="javascript:f_addTab('comment_list','物件提問管理','comment/list.aspx')">物件提問管理</a></li>
                        <%if (IsAdminLevel("sys_manager", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('sys_manager','管理員管理','manager/manager_list.aspx')">管理員管理</a></li>
                        <%}%>
                        <%if (IsAdminLevel("sys_nav", DTEnums.ActionEnum.View.ToString()))
                          { %>
                        <li><a class="l-link" href="javascript:f_addTab('sys_nav','網站導航','manager/nav_list.aspx')">網站導航</a></li>
                        <%}%>
                    </ul>
                </div>
            </div>
