...
<form id="form1" runat="server">
    <div class="navigation">首頁 &gt; 擴展屬性 &gt; 屬性列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
		    <a href="edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加屬性</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">選擇</th>
        <th width="20%" align="left">屬性名稱</th>
        <th align="left">備註</th>
    ...
    <FooterTemplate><%#rptList.Items.Count == 0 ? "<tr><td align=\"center\" colspan=\"6\">暫無記錄</td></tr>" : ""%></FooterTemplate>
    </asp:Repeater>
    </table>
