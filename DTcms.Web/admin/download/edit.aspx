...
<div class="navigation"><a href="javascript:history.go(-1);" class="back">後退</a>首頁 &gt; 下載管理 &gt; 編輯資料</div>
<div id="contentTab">
    <ul class="tab_nav">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th valign="top" style="padding-top:10px;">上傳附件：</th>
                <td>
                    ...
                    <div id="AttachList" class="attach_list">
                      <ul>
                        ...
                        <li>
                          ...
                          <span class="right">下載積分：<input name="txtPoint" type="text" class="input2" value="<%#Eval("point") %>" onkeydown="return checkNumber(event);" /></span>
