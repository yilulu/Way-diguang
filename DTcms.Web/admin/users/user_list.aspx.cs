...
namespace DTcms.Web.admin.users
{
    public partial class user_list : Web.UI.ManagePage
    {
        ...
        private void TreeBind(string strWhere)
        {
            ...
            this.ddlGroupId.Items.Add(new ListItem("同行", "10"));
        }
        #endregion
        ...
        protected string CombSqlTxt(int _group_id, string _keywords)
        {
            ...
            if (_group_id > 0)
            {
                strTemp.Append(" and group_id=" + _group_id + " group_id!=5");
            }
            _keywords = _keywords.Replace("'", "");
            if (!string.IsNullOrEmpty(_keywords))
            {
                strTemp.Append(" and (user_name like '%" + _keywords + "%' or email like '%" + _keywords + "%' or nick_name like '%" + _keywords + "%' or fuwuquyu like '%" + _keywords + "%')");
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批次刪除成功啦！", Utils.CombUrlTxt("user_list.aspx", "group_id={0}&keywords={1}",
