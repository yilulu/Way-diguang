        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            switch (this.prolistview)
            {
                case "Txt":
                    ...
                    this.rptList1.DataSource = bll.list_page(this.page, this.pageSize, " and" + _strWhere, _orderby);
                    this.rptList1.DataBind();
                    break;
                default:
                    this.rptList1.Visible = false;
                    this.rptList2.DataSource = bll.list_page(this.page, this.pageSize, " and" + _strWhere, _orderby);
                    this.rptList2.DataBind();
                    break;
            }
            //綁定頁碼
            this.totalCount = bll.GetNewsTatalNum(_strWhere);
