...
namespace DTcms.Web.front
{
    public partial class list2 : System.Web.UI.Page
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("list2.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("list2.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void ibtnViewTxt_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("list2.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
