<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="list_td.aspx.cs" Inherits="DTcms.Web.front.list_td" %>
   ...
   <body class="mainbody" style="width: 1100px; margin: 5px auto;">
            ...
            <div class="tools_box">
                <div class="tools_bar">
                    ...
                    <a href="td.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
                        class="tools_btn"><span><b class="add">添加土地</b></span></a>
            ...
            <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                                <%#Eval("title")%></a>
                        </td>
                        <td>
                            <%#Eval("shequ")%>
                        ...
                        <td align="center">
                            <a href="td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
            ...
            <asp:Repeater ID="rptList2" runat="server" OnItemCommand="rptList_ItemCommand">
                ...
                <ItemTemplate>
                    <li>
                        <div class="box">
                            ...
                            <dl>
                                <dt><a href="td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                                    <%#Eval("title")%></a></dt>
                ...
                <a href="td.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.edit_td %>&id=<%#Eval("id")%>"><img src="../images/ico-6.png" style="vertical-align:middle;" title="修改" /></a>
              </span>--%>
