...
namespace DTcms.Web.front
{
    public partial class hire : System.Web.UI.Page
    {
        ...
        private void setEmail()
        {
            ...
            DTMail.sendMail(model.emailstmp, model.emailport, model.emailfrom, model.emailpassword, model.emailusername, model.emailfrom, "empro@hotmail.com.tw", "帝光房屋會員刊登出租新物件", "帝光房屋會員刊登出租新物件");
        }
        #endregion
    }
}
