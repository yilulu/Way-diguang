<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="list2.aspx.cs" Inherits="DTcms.Web.front.list2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body class="mainbody" style="width: 1100px; margin: 5px auto;">
        ...
        <div class="tools_box">
            <div class="tools_bar">
                ...
                <a href="hire.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
                    class="tools_btn"><span><b class="add">添加商品</b></span></a>
            ...
            <div class="select_box">
                ...
                &nbsp; <%--添加類型:--%><asp:DropDownList ID="ddlProperty" runat="server" CssClass="select2" Visible="false"
                ...
                &nbsp;
            <asp:ImageButton ID="ibtnViewTxt" runat="server" ImageUrl="../admin/images/ico-show-txt.png"
                ToolTip="文字清單視圖" OnClick="ibtnViewTxt_Click" />
                <asp:ImageButton ID="ibtnViewImg" runat="server" ImageUrl="../admin/images/ico-show-img.png"
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
                    <tr>
                        ...
                        <th width="13%" align="left">所屬類別
                        </th>
                        <th width="16%" align="left">發佈時間
                        </th>
                        <th width="60" align="left">排序
                        </th>
                        <th width="110">狀態
                        </th>
                        <th width="8%">操作
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="hire.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                            <%#Eval("title")%></a>
                    </td>
                    <td>
                    ...
                    <td align="center">
                        <a href="hire.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                        <asp:LinkButton ID="lbtnShenk"
                            runat="server" CommandName="SK" CommandArgument='<%#Eval("id") %>' Text='<%#Eval("Status").ToString().Equals("0") ? "審核" :""%>' />
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
            ...
            <ItemTemplate>
                <li>
                    <div class="box">
                        ...
                        <dl>
                            <dt><a href="hire.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                                <%#Eval("title")%></a></dt>
                            <dd>價格：<%#Eval("sell_price")%>&nbsp; 人氣：<%#Eval("click")%></dd>
                            <dd>發佈時間：<%#string.Format("{0:g}",Eval("add_time"))%></dd>
                            <dd class="btns">
                                <%--  <span class="right">
                ...
                <a href="hire.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><img src="../images/ico-6.png" style="vertical-align:middle;" title="修改" /></a>
              </span>--%>
