...
namespace DTcms.Web.front
{
    public partial class td : System.Web.UI.Page
    {
        ...
        private int id = 0;
        protected int CataID = 0; protected string img_Url = string.Empty;
        ...
        private void setEmail()
        {
            ...
            DTMail.sendMail(model.emailstmp, model.emailport, model.emailfrom, model.emailpassword, model.emailusername, model.emailfrom, "empro@hotmail.com.tw", "帝光房屋會員刊登土地新物件", "帝光房屋會員刊登土地新物件");
        }
        #endregion
    }
}
