...
{
    public partial class list_kj : System.Web.UI.Page
    {
        protected int channel_id = 4;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string Url = Utils.CombUrlTxt("list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property);
