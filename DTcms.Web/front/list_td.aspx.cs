...
{
    public partial class list_td : System.Web.UI.Page
    {
        protected int channel_id = 10;
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("list_td.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected string CombSqlTxt(int _channel_id, int _category_id, string _keywords, string _property)
        {
            ...
            strTemp.Append("  and user_id =" + WEBUserCurrent.UserID + "and isFront=1");
            if (_channel_id > 0)
            {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("list_td.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void ibtnViewTxt_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("list_td.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string Url = Utils.CombUrlTxt("list_td.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property);
            this.Page.ClientScript.RegisterStartupScript(GetType(), "", "<script>alert('儲存排序成功');window.location.href='" + Url + "'</script>");
        }
