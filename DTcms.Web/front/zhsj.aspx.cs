...
{
    public partial class zhsj : System.Web.UI.Page
    {
        ...
        private bool DoAdd()
        {
            ...
            model.shequ = txtTeChang.Text.Trim();
        ...
        private void setEmail()
        {
            ...
            DTMail.sendMail(model.emailstmp, model.emailport, model.emailfrom, model.emailpassword, model.emailusername, model.emailfrom, "empro@hotmail.com.tw", "帝光房屋會員刊登裝潢新物件", "帝光房屋會員刊登裝潢新物件");
        }
        #endregion
    }
}
