<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="list_kj.aspx.cs" Inherits="DTcms.Web.front.list_kj" %>
   ...
   <body class="mainbody" style="width: 1100px; margin: 5px auto;">
            ...
            <div class="tools_box">
                <div class="tools_bar">
                    ...
                    <a href="zhsj.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"
                        class="tools_btn"><span><b class="add">添加空間規劃</b></span></a>
            ...
            <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="zhsj.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                                <%#Eval("title")%></a>
                        </td>
                        <td>
          ...
          <asp:ImageButton ID="ibtnSlide" CommandName="ibtnSlide" runat="server" ImageUrl='<%# Convert.ToInt32(Eval("is_slide")) == 1 ? "../Images/ico-4.png" : "../Images/ico-4_.png"%>' ToolTip='<%# Convert.ToInt32(Eval("is_slide")) == 1 ? "取消幻燈片" : "設置幻燈片"%>' />
                        ...
                        <td align="center">
                            <a href="zhsj.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                ...
                <ItemTemplate>
                    <li>
                        <div class="box">
                            ...
                            <dl>
                                <dt><a href="zhsj.aspx?channel_id=<%#this.channel_id %>&action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                                    <%#Eval("title")%></a></dt>
