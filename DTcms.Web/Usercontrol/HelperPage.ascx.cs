...
namespace DTcms.Web
{
    public partial class HelperPage : System.Web.UI.UserControl
    {
        ...
        {
            string Url = "http://" + DTcms.Common.Utils.GetHomeUrl() + "/";
            ...
            for (int i = 0; i < table.Rows.Count; i++)
            {
                ...
                if (table2 != null && table2.Rows.Count > 0)
                {
                    ...
                    {
                        HtmlSte += "<span class=\"xgj_ms\"><a href='" + Url + "newsview.aspx?type=1&id=" + table2.Rows[j]["id"] + "' target='_blank'>" + table2.Rows[j]["title"] + "</a>";
                        HtmlSte += "</span>";
                    }
                }
                HtmlSte += "</span></li>";
