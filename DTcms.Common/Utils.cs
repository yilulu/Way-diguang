...
namespace DTcms.Common
{
    public class Utils
    {
        ...
        public static void MakeFile(string content, string StackTrace)
        {
            try
            {
                ...
                string dicName = Path.GetDirectoryName(str);
                //if (!Directory.Exists(dicName) && !string.IsNullOrEmpty(dicName))
                //{
                ...
                sw.WriteLine("");
                sw.WriteLine("");
                sw.WriteLine("(IP:" + DTRequest.GetIP() + ")" + "\t" + System.DateTime.Now + "\t" + content);
